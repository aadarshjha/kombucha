...
import DeleteArticle from "../../views/login/deleteArticle";
...
it("renders newArticle.tsx without crashing", () => {
  ...
  ReactDOM.render(<DeleteArticle />, div);
...
it("matches learn page snapshot", () => {
  const tree = renderer.create(<DeleteArticle />).toJSON();
